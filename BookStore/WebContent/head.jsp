	...
	<table cellspacing="0" class="headtable">
		<tr>
			...
			<td style="text-align:right"><img src="images/cart.gif"
				...
				href="cart.jsp">购物车</a> | <a href="#">帮助中心</a> | <a href="${pageContext.request.contextPath}/Select">我的帐户</a>
				| <a href="register.jsp">新用户注册</a> | <a href="${pageContext.request.contextPath}/logOff">注销</a>  </td>
		</tr>
	</table>
</div>