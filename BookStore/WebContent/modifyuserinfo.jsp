			...
			<tr>
				...
				<td>
					...
					<table cellspacing="0" class="infocontent">
						<tr>
							<td>
								<form action="${pageContext.request.contextPath}/alterMsg" method="post">
									<input type="hidden" name="id" value="">
									<table width="100%" border="0" cellspacing="2" class="upline">
										<tr>
										   ${errorAlter}
											<td style="text-align:right; width:20%">会员邮箱：</td>
											<td style="width:40%; padding-left:20px">${email}</td>
											<td>&nbsp;</td>
										...
										<tr>
											...
											<td style="padding-left:20px">${user}</td>
											<td>&nbsp;</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><input type="password" class="textinput" name="password2" />
											</td>
											<td>${errorMsg }</td>
										</tr>
										<tr>
